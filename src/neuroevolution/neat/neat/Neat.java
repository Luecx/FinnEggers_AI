...
import neuroevolution.neat.genes.ConnectionGene;
import neuroevolution.neat.genes.NodeGene;
...
public class Neat {
    ...
    private double NODE_MUTATION_RATE = 0.1;
    private double CONNECTION_MUTATION_RATE = 0.22;
    private double CONNECTION_ENABLE_DISABLE_RATE = 0.05;
    private double CONNECTION_ENABLE_DISABLE_RESET_RATE = 0.25;

    private double WEIGHT_MUTATION_RATE = 0.2;
    private double WEIGHT_MUTATION_STRENGTH = 4;
    private double WEIGHT_TOTALLY_RANDOM = 0.1;

    private double SURVIVAL_PERCENTAGE = 0.2;

    private double C1 = 0.8;
    private double C2 = 0.8;
    private double C3 = 0.3;
    private double CP = 15;
